                    ...
                    columns: [
                        {
                            ...
                            template: function(data) {
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="ml-4">
                                        <div class="text-dark-75 font-weight-bolder font-size-lg mb-0">${data.nombre_usuario}</div>
                                        <a href="#" class="text-muted font-weight-bold text-hover-primary">DNI: ${data.dni_usuario}</a>
                                    </div>
                                </div>
                                `;
                            ...
                            template: function(data) {
                                ...
                                if (data.tel_usuario) {
                                    ...
                                    <div class="d-flex align-items-center" style="gap: 5px;">
                                        ...
                                        <a href="tel:${data.tel_usuario}" class="text-muted font-weight-bold text-hover-primary">${data.tel_usuario}</a>
                                    </div>
                                    `;
                                }
                            ...
                            template: function(data) {
                                ...
                                if (data.correo_usuario) {
                                    ...
                                    <div class="d-flex align-items-center" style="gap: 5px;">
                                        ...
                                        <a href="mailto:${data.correo_usuario}" class="text-muted font-weight-bold text-hover-primary">${data.correo_usuario}</a>
                                    </div>
                                    `;
                                }

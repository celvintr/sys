                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        <div class="ml-4">
                                                            ...
                                                            <p class="text-muted font-weight-bold text-hover-primary mb-0"><span class="text-dark-75 font-weight-bolder font-size-lg mb-0">Centro:</span> {{ $custodio->centro->nombre_centro }} - {{ $custodio->centro->nombre_sector_electoral }}</p>
